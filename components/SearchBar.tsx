    ...
    <div ref={containerRef} className="relative w-full">
      <div className="relative flex items-center">
        ...
        <input ref={inputRef} value={query}
          ...
          className="w-full pl-11 pr-8 h-[46px] rounded-full outline-none text-[14px] font-light text-gray-800 placeholder-[#666] transition-all focus:ring-1 focus:ring-[#FFB703]/60"
